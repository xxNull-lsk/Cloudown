...
class UITaskActive(UITask):
    def __init__(self):
        ...
        self.label_download_speed.setFixedWidth(96)
        self.label_download_speed.setAlignment(Qt.AlignRight | Qt.AlignVCenter)
        self.info_layout.addWidget(self.label_download_speed)

        self.label_upload_speed = QLabel()
        self.label_upload_speed.setFixedWidth(96)
        self.label_upload_speed.setAlignment(Qt.AlignRight | Qt.AlignVCenter)
        self.info_layout.addWidget(self.label_upload_speed)

        self.label_connects = QLabel()
        self.label_connects.setFixedWidth(96)
        self.label_connects.setAlignment(Qt.AlignRight | Qt.AlignVCenter)
    ...
    def set_task(self, task):
        ...
        self.label_download_speed.setText(self.tr('{}/s').format(size2string(download_speed)))
        if task['uploadSpeed'] != '0':
            self.label_upload_speed.setText(self.tr('{}/s').format(size2string(task['uploadSpeed'])))
        else:
